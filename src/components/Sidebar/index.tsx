import { Search, House, Inbox, Plus, Settings, Trash2, ChevronDown, MoreHorizontal } from 'lucide-react';
...
export function Sidebar({ tree }: { tree: PageNode[] }) {
  return (
    <aside className="flex h-full w-65 shrink-0 flex-col items-start overflow-clip px-3 pt-3.5 pb-4">
      {/* Workspace switcher */}
      ...
      {/* <nav className="flex w-full flex-col items-start gap-px overflow-clip py-2">
        ...
        <SidebarItem href="/inbox" icon={<Inbox className="size-4" />} label="Inbox" />
      </nav> */}
